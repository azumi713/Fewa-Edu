document.addEventListener('DOMContentLoaded', function() {
  ...
  // Expandable element functionality (assuming the element exists in HTML)
  ...
  // Revealed elements functionality
  ...
  function onScroll() {
    var featuresPosts = document.querySelectorAll('.features-post');

    featuresPosts.forEach(function(post) {
